  ...
  return (
    <div>
      ...
      <section className='hero-area-one'>
          ...
          <div className='container'>
            <div className='row justify-content-center'>
              <div className='col-xl-10'>
                ...
                <h1 className='title wow fadeInUp' data-wow-delay='0.4s'>Donate to win <br /> We reward your support.</h1>
        ...
        <div className='hero-images'>
          <div className='hero-img image-small fancy-bottom wow fadeInLeft' data-wow-delay='0.6s'>
            <img src='dist/img/hero/hero-one-small.jpg' alt='Image' />
          </div>
          <div className='hero-img main-img wow fadeInUp' data-wow-delay='0.5s'>
            <img src='dist/img/hero/hero-one-big.jpg' alt='Image' />
          </div>
          <div className='hero-img image-small fancy-top wow fadeInRight' data-wow-delay='0.7s'>
            <img src='dist/img/hero/hero-one-small-2.jpg' alt='Image' />
          </div>
        </div>
      </section>
      {/* ====== Hero Area End ====== */}
        ...
        <div className='container'>
          <div className='categories-header'>
            <div className='row align-items-center justify-content-between'>
              ...
              <div className='col-auto'>
                <a href='project-1.html' className='main-btn mb-30'>View All Category <i className='far fa-angle-right' /></a>
              </div>
            </div>
          </div>
          ...
          <div className='row align-items-center justify-content-lg-start justify-content-center'>
            <div className='col-xl-6 col-lg-7 col-md-9'>
              <div className='about-img'>
                <img src='dist/img/about/about-one.jpg' alt='Image' />
              </div>
            </div>
            <div className='col-xl-4 col-lg-5 col-md-10 offset-xl-1'>
              <div className='about-text mt-md-70 mb-md-50'>
                ...
                <div className='author-note wow fadeInUp'>
                  <ul>
                    <li><i className='far fa-check' /> Non-Profite Crowdfunding Agency</li>
                    <li><i className='far fa-check' /> We're Successful Institute </li>
                  </ul>
                  <div className='author-info'>
                    <div className='author-img'>
                  <img src='dist/img/author-thumbs/01.jpg' alt='Image' />
                </div>
          ...
          <div className='row project-slider-one project-items project-style-one no-shadow'>
            <div className='col'>
              <div className='project-item'>
                <div className='thumb' style={{ backgroundImage: 'url(dist/img/project/project-grid-01.jpg)' }} />
                <div className='content'>
                  <div className='cats'>
            ...
            <div className='col'>
              <div className='project-item'>
                <div className='thumb' style={{ backgroundImage: 'url(dist/img/project/project-grid-02.jpg)' }} />
                <div className='content'>
                  <div className='cats'>
                    <a href='#'>Educations</a>
                  </div>
            ...
            <div className='col'>
              <div className='project-item'>
                <div className='thumb' style={{ backgroundImage: 'url(dist/img/project/project-grid-03.jpg)' }} />
                <div className='content'>
                  <div className='cats'>
                    <a href='#'>Technology</a>
                  </div>
            ...
            <div className='col'>
              <div className='project-item'>
                <div className='thumb' style={{ backgroundImage: 'url(dist/img/project/project-grid-04.jpg)' }} />
                <div className='content'>
                  <div className='cats'>
                    <a href='#'>Clothes</a>
                  </div>
            ...
            <div className='col'>
              <div className='project-item'>
                <div className='thumb' style={{ backgroundImage: 'url(dist/img/project/project-grid-05.jpg)' }} />
                <div className='content'>
                  <div className='cats'>
                    <a href='#'>Covid -19</a>
                  </div>
            ...
            <div className='col'>
              <div className='project-item'>
                <div className='thumb' style={{ backgroundImage: 'url(dist/img/project/project-grid-06.jpg)' }} />
                <div className='content'>
                  <div className='cats'>
                    <a href='#'>Business</a>
                  </div>
            ...
            <div className='col'>
              <div className='project-item'>
                <div className='thumb' style={{ backgroundImage: 'url(dist/img/project/project-grid-07.jpg)' }} />
                <div className='content'>
                  <div className='cats'>
                    <a href='#'>Technology</a>
                  </div>
            ...
            <div className='col'>
              <div className='project-item'>
                <div className='thumb' style={{ backgroundImage: 'url(dist/img/project/project-grid-08.jpg)' }} />
                <div className='content'>
                  <div className='cats'>
            ...
            <div className='col'>
              <div className='project-item'>
                <div className='thumb' style={{ backgroundImage: 'url(dist/img/project/project-grid-09.jpg)' }} />
                <div className='content'>
                  <div className='cats'>
                    <a href='#'>Business</a>
                  </div>
          ...
          <div className='row align-items-center justify-content-center'>
            <div className='col-xl-4 col-lg-6 col-md-8 col-sm-10'>
              <div className='testimonials-content mb-lg-50'>
                ...
                <a href='testimonial.html' className='main-btn mt-35'>View All Reviews <i className='far fa-arrow-right' /></a>
                <div className='testimonial-author-boxes wow fadeInUp' data-wow-delay='0.2s'>
                  ...
                  <a href='#'><img src='dist/img/author-thumbs/01.jpg' alt='user one' /></a>
                </li>
                    <li data-tooltip='true' data-placement='top' data-original-title='Evan A. Ethridge'>
                  <a href='#'><img src='dist/img/author-thumbs/02.jpg' alt='user one' /></a>
                </li>
                    <li data-tooltip='true' data-placement='top' data-original-title='Donald L. Lewis'>
                  <a href='#'><img src='dist/img/author-thumbs/03.jpg' alt='user one' /></a>
                </li>
                    <li data-tooltip='true' data-placement='top' data-original-title='Marcus L. Duncan'>
                  <a href='#'><img src='dist/img/author-thumbs/04.jpg' alt='user one' /></a>
                </li>
                    <li data-tooltip='true' data-placement='top' data-original-title='Evan A. Ethridge'>
                  <a href='#'><img src='dist/img/author-thumbs/05.jpg' alt='user one' /></a>
                </li>
                    <li data-tooltip='true' data-placement='top' data-original-title='M. Jon Doe'>
                  <a href='#'><img src='dist/img/author-thumbs/06.jpg' alt='user one' /></a>
                </li>
                    <li data-tooltip='true' data-placement='top' data-original-title='More'>
                  <a href='#' className='more-icon'><i className='far fa-plus' /></a>
                </li>
                  </ul>
                </div>
              </div>
      ...
      <section className='emergency-project-with-cta'>
        <div className='container'>
          {/* Call to Action */}
          <div className='cta-box cta-double-content' style={{ backgroundImage: 'url(dist/img/cta/01.jpg)' }}>
            <div className='row justify-content-center'>
              <div className='col-xl-4 col-lg-5 col-md-9'>
                <div className='content'>
                  ...
                  <p>Sed perspiciatis unde omniste natus error sit voluptatem accusantium doloremque laudan
                    totamrem aperiam eaque quae abille
              </p>
                  <a href='events.html' className='main-btn'>Start a Funden <i className='far fa-arrow-right' /></a>
                </div>
              </div>
        ...
        <div className='emergency-project-slider'>
          <div className='container'>
            ...
            <div className='row project-slider-two project-items project-style-four'>
              ...
              <div className='col'>
                <div className='project-item'>
                  <div className='thumb' style={{ backgroundImage: 'url(dist/img/project/project-slider-02.jpg)' }} />
                  <div className='content'>
                    <div className='cats'>
                  <a href='#'>Covid -19</a>
                </div>
          ...
          <div className='row partners-logos-one'>
            <div className='col-lg-3 col-md-4 col-sm-6'>
              <div className='logo mt-30'>
                <a href='#'><img src='dist/img/partners/01.png' alt='Image' /></a>
              </div>
            </div>
            <div className='col-lg-3 col-md-4 col-sm-6'>
              <div className='logo mt-30'>
                <a href='#'><img src='dist/img/partners/02.png' alt='Image' /></a>
              </div>
            </div>
            <div className='col-lg-3 col-md-4 col-sm-6'>
              <div className='logo mt-30'>
                <a href='#'><img src='dist/img/partners/03.png' alt='Image' /></a>
              </div>
            </div>
            <div className='col-lg-3 col-md-4 col-sm-6'>
              <div className='logo mt-30'>
                <a href='#'><img src='dist/img/partners/04.png' alt='Image' /></a>
              </div>
            </div>
            <div className='col-lg-3 col-md-4 col-sm-6'>
              <div className='logo mt-30'>
                <a href='#'><img src='dist/img/partners/05.png' alt='Image' /></a>
              </div>
            </div>
            <div className='col-lg-3 col-md-4 col-sm-6'>
              <div className='logo mt-30'>
                <a href='#'><img src='dist/img/partners/06.png' alt='Image' /></a>
              </div>
            </div>
            <div className='col-lg-3 col-md-4 col-sm-6'>
              <div className='logo mt-30'>
                <a href='#'><img src='dist/img/partners/07.png' alt='Image' /></a>
              </div>
            </div>
            <div className='col-lg-3 col-md-4 col-sm-6'>
              <div className='logo mt-30'>
                <a href='#'><img src='dist/img/partners/08.png' alt='Image' /></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='container'>
          ...
          <div className='row justify-content-center latest-blog-posts style-one'>
            <div className='col-lg-4 col-md-6 col-sm-9 col-11 wow fadeInUp' data-wow-delay='0.1s'>
              <div className='latest-post-box mt-30'>
                <div className='post-thumb'>
                  <img src='dist/img/latest-news/01.jpg' alt='Image' />
                </div>
                <div className='post-content'>
                  <a href='#' className='post-date'><i className='far fa-calendar-alt' /> 25 February 2021</a>
                  <h6 className='title'>
                    <a href='news-details.html'>Standing Out From Crowds mproving Mobile Experience</a>
                  </h6>
                  <a href='news-details.html' className='post-link'>Read More <i className='far fa-arrow-right' /></a>
                </div>
              </div>
            </div>
            <div className='col-lg-4 col-md-6 col-sm-9 col-11 wow fadeInUp' data-wow-delay='0.2s'>
              <div className='latest-post-box mt-30'>
                <div className='post-thumb'>
                  <img src='dist/img/latest-news/02.jpg' alt='Image' />
                </div>
                <div className='post-content'>
                  <a href='#' className='post-date'><i className='far fa-calendar-alt' /> 25 February 2021</a>
                  <h6 className='title'>
            ...
            <div className='col-lg-4 col-md-6 col-sm-9 col-11 wow fadeInUp' data-wow-delay='0.3s'>
              <div className='latest-post-box mt-30'>
                <div className='post-thumb'>
                  <img src='dist/img/latest-news/03.jpg' alt='Image' />
                </div>
                <div className='post-content'>
                  <a href='#' className='post-date'><i className='far fa-calendar-alt' /> 25 February 2021</a>
                  <h6 className='title'>
